...
public abstract class BaseRequest {
    ...
    protected void sendFailMsg(int code, String reason) {
        ...
        Log.d(TAG,"sendFailMsg"+code);
        Log.d(TAG,"sendFailMsg"+reason);
        msg.arg1 = code;
        msg.obj = reason;
        uiHandler.sendMessage(msg);
    }

    protected  void sendSuccMsg(String data) {
        Message msg = uiHandler.obtainMessage(WHAT_SUCC);
        Log.d(TAG,"sendSuccMsg"+data.toString());
        msg.obj = data;
        uiHandler.sendMessage(msg);
    }
    ...
    public void PostRequest(String url, FormBody formBody){
        //okhttp,Dogpost请求
        final Request request = new Request.Builder()
                .url(url)
                .post(formBody)
    ...
    protected abstract <T> void onResponseSuccess(String body);
